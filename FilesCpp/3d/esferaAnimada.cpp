...
float sphereRotation = 0.0f; // Variable para controlar la rotación de la esfera
...
void display() {
    ...
    glRotatef(sphereRotation, 0.0f, 1.0f, 0.0f); // Rotamos la esfera
...
void update(int value) {
    // Incrementar el ángulo de rotación de la esfera
    sphereRotation += 0.5f;
    ...
    // Establecer la próxima actualización
...
int main(int argc, char** argv) {
    ...
    // Iniciar el temporizador para la actualización de la escena
    glutTimerFunc(16, update, 0);
